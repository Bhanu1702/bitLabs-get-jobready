...
public class AarogyaHospital{
    ...
    boolean recovered;
        ...
        System.out.println("guardians address :");
        guardian_address = ip.nextLine();
        System.out.println("guardians contactNumber :");
  ...
  static void displayDetails(AarogyaHospital.AarogyaMember patient){
    ...
    System.out.println("patient contactNumber :"+patient.contact_number);
  }
      ...
      boolean found;
		while(true){
			...
			// take the input and add in the arrayList
	            ...
	            AarogyaHospital.AarogyaMember newpatient = hospital.new 
              AarogyaMember();
        newpatient.input();
	              ...
	              // take member id as input to maintain recovered information of patient
                   ...
                   it=patients.iterator();
                    ...
                    System.out.println("patient "+patient.id+" has been marked as recovered");
                         ...
                         else System.out.println("this patient already marked as recovered: ");
                            }
                     }
                     if(!found) System.out.println("No information about patient: ");
	             }
